...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger, DialogSubTitle, DialogFooter } from "@/components/ui/dialog"
import { 
  Code2, 
  Globe, 
  Laptop, 
...
const Icon = ({IconElement, title}: {IconElement: React.ComponentType<React.ComponentProps<any>>, title: string}) => {
  return(
    <span title={title} className="group/icon flex relative">
    <IconElement color="fuchsia-400" className="text-3xl mb-2 fill-fuchsia-400 hover:fill-fuchsia-500" />
    <span className="group-hover/icon:opacity-100 transition-opacity bg-gray-800 px-1 text-sm text-gray-100 rounded-md absolute left-1/2 
    -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto text-nowrap z-10">{title}</span>
    </span>
  )
}
...
const projects: Project[] = [
  {
    ...
    img_folder: "poppets",
    description: "Blockchain-based collectibles featuring 3D characters procedurally generated from hundreds of swappable attributes, animated with Unreal Engine, and stored on IPFS, with ownership verified on the Ethereum network.",
    images: [
      { src: "maker.jpg", caption: "Built a retro-themed, web-based tool for previewing characters with various accessories, color palettes, and creative choices." },
      { src: "orphanarium.jpg", caption: "Transformed a fully immersive 3D environment into an interactive website." },
      { src: "blasted.jpg", caption: "Oversaw art direction and character design, smart contract development, and generative art software creation for 2D \"Popkins\" on Blast blockchain."},
      { src: "pvp.jpg", caption: "Created a fully-onchain card game (Cats, Cleavers, and Cockroaches) and web interface to play it." },
    ],
  ...
  },
  {
    ...
    img_folder: "trivie",
    description: "With Trivie, I helped build a pre-LLM Natural Language Processing platform that gamifies professional learning by allowing users to compete in trivia challenges and earn prizes. Additionally, I helped to reduce latency in their MySQL queries by over 80% and assisted in development of their administrative interface.",
    images: [
      { src: "app.png", caption: "Trivie gamifies professional learning by allowing users to compete in trivia challenges and earn prizes." },
      { src: "aiinterface.jpg", caption: "Unique questions and meaningful distractors are generated from a client's knowledge base." },
    ],
    ...
    tools: (
      <div className="flex flex-wrap pt-4 px-10 background-slate-800 mx-auto text-center align-center justify-center text-3xl gap-2">
        <Icon IconElement={PythonIcon} title="Python" />
        <Icon IconElement={AWSIcon} title="AWS" />
        <Icon IconElement={HuggingFaceIcon} title="Natural Language Processing" />
        <Icon IconElement={SpacyIcon} title="spaCy" />
        <Icon IconElement={DjangoIcon} title="Django" />
        <Icon IconElement={NginxIcon} title="Nginx" />
        <Icon IconElement={DockerIcon} title="Docker" />
  ...
  },
  {
    ...
    img_folder: "noble",
    description: "Noble Labs is a locally owned and operated company that aims to provide a well-controlled supply chain of safe and consistent cannabis-based medicine to patients statewide.",
    images: [
      { src: "thumbnail.png", caption: "Creation of a website for a local cannabis-based medicine company." },
    ],
...

  {
    ...
    subtitle: "Informational website for local attorney and social justice advocate",
    img_folder: "alison",
    description: "I helped Alison McCrary, a local attorney and social justice advocate, create a website to share her work and connect with her community.",
    images: [
      { src: "thumbnail.png", caption: "Creation of a website for a local attorney and social justice advocate." },
    ],
  ...
  
  {
    ...
    img_folder: "gridview",
    description: "While working for St. George's Episcopal School during the pandemic, I created a Chrome extension that enhances Google Meet with a customizable grid view, benefiting over 9 million users worldwide and ultimately being acquired by Google.",
    images: [
      { src: "staff.webp", caption: "St. George's Administrative Staff demonstrating the Grid View" },
      { src: "news.jpg", caption: "Grid View was featured in local and national news, rocketing from 100 users to over 9 million users in less than a month." },
    ],
    url: "",
    tools: (
      <div className="flex flex-wrap pt-4 px-10 background-slate-800 mx-auto text-center align-center justify-center text-3xl gap-2">
  ...
  },
  {
    ...
    img_folder: "forks",
    description: "With my daughter, I helped create a collection of 10,000 uniquely generated NFTs for Second Harvest Food Bank, a charity that fights hunger in the greater New Orleans metropolitan area. We raised over $150,000 for the charity and received national attention.",
    images: [
      { src: "thumbnail.png", caption: "Caption one." },
  ...
  },
  {
    ...
    img_folder: "maneki",
    description: "I helped create a fully playable NFT game on the Ethereum blockchain based on the \"Lucky Maneki\" theme. I created the smart contracts and helped with the game design.",
    images: [
      { src: "thumbnail.png", caption: "Caption one." },
...
const clients = [
  ...
  { name: "Noble Labs", logo: "/placeholder.svg?height=100&width=200" },
  { name: "Trivie", logo: "/placeholder.svg?height=100&width=200" },
  { name: "MLB: The Show", logo: "/placeholder.svg?height=100&width=200" },
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[625px] bg-black border-fuchsia-500">
        <DialogHeader>
          <DialogTitle className="text-fuchsia-400">{project.title}</DialogTitle>
          <DialogSubTitle className="text-fuchsia-300">{project.subtitle}</DialogSubTitle>
          <DialogDescription className="text-zinc-400">{project.description}</DialogDescription>
          {project.url && (
            <a href={project.url} target="_blank" rel="noopener noreferrer" className="absolute right-2 top-2 text-fuchsia-200 hover:text-fuchsia-600 text-sm" title="visit web"><Globe className="h-4 w-4 mb-2 inline"  /> {project.url.split("://")[1]}</a>
          )}
        </DialogHeader>
        <div className="relative">
          ...
          />
          <p className="text-center mt-2 text-fuchsia-300">{project.images[currentImage].caption}</p>
          <Button className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-fuchsia-600 hover:bg-fuchsia-700" onClick={prevImage}>
            ←
          </Button>
          <Button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-fuchsia-600 hover:bg-fuchsia-700" onClick={nextImage}>
            →
          </Button>
        </div>
        <DialogFooter>
...
export function ResumePageComponent() {
  ...
  const rotatingWords = ["Web", "Mobile", "Web3", "AI", "Desktop", "Blockchain", "What's Next"]
    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-fuchsia-500">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <Link className="text-sm font-medium hover:text-fuchsia-400 hover:underline underline-offset-4 pixel-text" href="#services">
            Services
          </Link>
          <Link className="text-sm font-medium hover:text-fuchsia-400 hover:underline underline-offset-4 pixel-text" href="#work">
            Work
          </Link>
          <Link className="text-sm font-medium hover:text-fuchsia-400 hover:underline underline-offset-4 pixel-text" href="#contact">
            Contact
          </Link>
        </nav>
      </header>
      <main className="flex-1">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
              <div className="md:w-1/4">
                <div className="rounded-full relative md:min-w-40 w-32 h-32 md:h-full md:w-full group aspect-square">
                  ...
                  <img
                    src="https://gateway.lighthouse.storage/ipfs/bafkreigudueaemohpibr6igtp3e5ayrh35awysxtdsgxnq3vujtisuwe7y?filename=ryan.jpg"
                    alt="Ryan Meyers"
              ...
              <div className="w-full md:w-3/4 space-y-4 text-center">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-7xl lg:text-8xl/none xl:text-9xl/none text-white drop-shadow-lg cursor-wait">
                  <span className="hover:font-['Press_Start_2P'] hover:text-[84%] hover:text-lime-500">R</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[68%] hover:text-blue-400">y</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[67%] hover:text-red-400">a</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[77%] hover:text-yellow-400">n</span>
                  &nbsp;
                  <span className="hover:font-['Press_Start_2P'] hover:text-[84%] hover:text-purple-500 hover:ml-10">M</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[60%] hover:text-pink-500">e</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[68%] hover:text-yellow-400">y</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[59%] hover:text-red-400">e</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[54%] hover:text-blue-400">r</span>
                  <span className="hover:font-['Press_Start_2P'] hover:text-[58%] hover:text-lime-500">s</span>
                </h1>
                <div className="h-6 md:h-12 flex flex-row items-end justify-around text-xl md:text-2xl lg:text-3xl xl:text-4xl text-zinc-200 group text-right"> {/* Fixed height container for rotating text */}
                 
                    <span className="flex-grow">Creative solutions for</span>
                    <span className="w-5/12 h-12 relative">
                      <span className="absolute top-1/2 left-3 -translate-y-1/4 md:-translate-y-1/2 pt-1 font-['Monoton'] text-fuchsia-300 group-hover:opacity-0 opacity-100">{rotatingText}</span>
                      <span className="absolute top-1/2 left-3 -translate-y-1/4 md:-translate-y-1/2 pt-1 font-['Press_Start_2P'] text-[70%] md:text-[81%]  text-green-500 group-hover:opacity-100 opacity-0">{rotatingText}</span>
                      </span>
        ...
        <section id="services" className="w-full py-12 md:py-24 lg:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 text-fuchsia-400">What I do...</h2>
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                ...
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">Web Design</h3>
                <p className="text-sm text-zinc-200 text-center">
                  Creative, responsive, and functional web design for your business or personal brand utilizing modern frameworks and technologies.
                </p>
                <WebDesignIcons />
              ...
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                ...
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">Web Infra</h3>
                <p className="text-sm text-zinc-200 text-center">
                  Designing, implementing, and maintaining robust and scalable server infrastructures using industry-standard tools and best practices.
                </p>
              ...
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                ...
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">App Development</h3>
                <p className="text-sm text-zinc-200 text-center">
                  Native and cross-platform mobile applications for iOS and Android; desktop applications for MacOS, ChromeOS, Linux, and Windows; bespoke solutions for on-device and on-premise applications.
                </p>
                <AppIcons />
              </div>
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                <BrainCircuit className="h-12 w-12 mb-2 text-fuchsia-400" />
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">AI Integration</h3>
                <p className="text-sm text-zinc-200 text-center">
                  Implementing AI and machine learning solutions for various applications; including but not limited to: Chatbots, Generative AI, and AI Agents.
                </p>
                <AIIcons />
              </div>
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                <Cuboid className="h-12 w-12 mb-2 text-fuchsia-400" />
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">Web3 &amp; Blockchain</h3>
                <p className="text-sm text-zinc-200 text-center">
                  Blockchain and decentralized application development using Web3 technologies with special emphasis on Smart Contracts, NFTs, and DeFi.
                </p>
                <Web3Icons />
              </div>
              <div className="flex flex-col items-center space-y-2 border-2 border-fuchsia-500 p-4 rounded-lg transition-transform hover:scale-105">
                <LoaderPinwheel className="h-12 w-12 mb-2 text-fuchsia-400" />
                <h3 className="text-xl font-bold text-fuchsia-300 text-center">Kitchen Sink</h3>
                <p className="text-sm text-zinc-200 text-center">
                  I'm not afraid of learning or trying something new; in fact, I thrive on it. I've built everything from applications that render 3D animations, Discord and Telegram bots, Snapchat and Instagram filters, scalable server infrastructures, and everything in between.
                </p>
                <KitchenSinkIcons />
              </div>
            </div>
        ...
        <section id="work" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-purple-900 via-fuchsia-900 to-pink-900">
          <div className="container mx-auto px-4 md:px-6">
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-purple-900 via-fuchsia-900 to-pink-900">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 text-fuchsia-300">
              Contact Me
            </h2>
            <div className="grid gap-10 sm:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2 text-fuchsia-300">
                  ...
                  <span>@ryanmeyers</span>
                </div>
              </div>
              <form className="space-y-4">
                <Input placeholder="Your Name" className="bg-fuchsia-900 border-fuchsia-500 text-white placeholder-fuchsia-300" />
                <Input type="email" placeholder="Your Email" className="bg-fuchsia-900 border-fuchsia-500 text-white placeholder-fuchsia-300" />
                <Textarea placeholder="Your Message" className="bg-fuchsia-900 border-fuchsia-500 text-white placeholder-fuchsia-300" />
                <Button type="submit" className="w-full bg-fuchsia-600 hover:bg-fuchsia-700 text-white pixel-text">Send Message</Button>
              </form>
            </div>
          </div>
        </section>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-fuchsia-500">
        <p className="text-xs text-zinc-400 dark:text-zinc-400">© 2024 Ryan Meyers. All rights reserved.</p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <Link className="text-xs hover:underline underline-offset-4 text-zinc-400 hover:text-fuchsia-400" href="#">
            Terms of Service
          </Link>
          <Link className="text-xs hover:underline underline-offset-4 text-zinc-400 hover:text-fuchsia-400" href="#">
            Privacy
